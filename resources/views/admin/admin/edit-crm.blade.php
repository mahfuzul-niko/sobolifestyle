...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.update.crm', $admin->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="type" class="form-control">
                                <option value="4" {{ $admin->type == 4 ? 'selected' : '' }}>All</option>
                                <option value="5" {{ $admin->type == 5 ? 'selected' : '' }}>Product System</option>
                                <option value="6" {{ $admin->type == 6 ? 'selected' : '' }}>Order System</option>
                            </select>
                        </div>
                    </div>
