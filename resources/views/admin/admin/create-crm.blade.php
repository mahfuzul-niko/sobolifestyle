...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.store.crm') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="type" id="" class="form-control">
                                ...
                                <option value="5">Product System</option>
                                <option value="6">Order System</option>
                            </select>
                        </div>
                    </div>
