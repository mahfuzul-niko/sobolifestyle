                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="">
                                                    <input type="file" name="image2"
                                                        class="form-control @error('image2') is-invalid @enderror" required>
                                                    @error('image2')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <label class="form-check-label" for="for_single">Single</label>
                                                ...
                                                <div
                                                    ...
                                                    <input class="form-check-input" type="radio" name="type"
                                                        id="for_variation" value="variation" selected>
                                ...
                                <div class="shadow p-2">
                                    <div class="form-group">
                                        ...
                                        <label for="is_featured" class="mr-3">
                                            <input type="checkbox" checked name="is_featured" value="1"
                                                id="is_featured">
                                            Featured Products
                                        </label>

                                        <label for="is_tranding" class="mr-3">
                                            <input type="checkbox" checked name="is_tranding" value="1"
                                                id="is_tranding">
                                            Tranding Product
                                        </label>

                                        <label for="todays_deal" class="mr-3 d-none">
                                            <input type="checkbox" checked name="todays_deal" value="1"
                                                id="todays_deal">
                                            Today's Deal
                                        </label>
                            ...
                            <div class="col-md-6 my-3">
                                <div class="shadow p-2">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="Fites" class="mr-3"><b>Fit</b></label>

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="fit"
                                                        value="" id="fit_none" checked>
                                                    <label class="form-check-label" for="fit_none">
                                                        None
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="fit_slim">
                                                        Slim Fit
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="fit_regular">
                                                        Regular Fit
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="fit_tapered">
                                                        Tapered Fit
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="fabrication" class="mr-3"><b>Fabrication</b></label>

                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="fabrication"
                                                        value="" id="fabrication_none" checked>
                                                    <label class="form-check-label" for="fabrication_none">
                                                        None
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="fabrication_knit">
                                                        Knit
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="fabrication_woven">
                                                        Woven
                                                    </label>
                                                </div>
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="fabrication_jersey">
                                                        Jersey
                                                    </label>
                                                </div>
                                            </div>
