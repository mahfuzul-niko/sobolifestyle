                    ...
                    <div class="product__details--info">
                        ...
                        <div class="footer__social mt-1" style="color: #000 !important">
                            <ul class="social__shear d-flex">
                                    ...
                                    <a class="social__shear--list__icon" target="_blank"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="7.667" height="16.524"
                                            ...
                                            <path data-name="Path 237"
                                                ...
                                                transform="translate(-960.13 -345.407)" fill="#000" />
                                        </svg>
                                ...
                                <li class="social__shear--list">
                                    <a class="social__shear--list__icon" target="_blank"
                                        href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode('Check this out!') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.489" height="13.384"
                                            ...
                                            <path data-name="Path 303"
                                                ...
                                                transform="translate(-951.23 -1140.849)" fill="#000" />
                                        </svg>
                                        <span class="visually-hidden">Twitter</span>
                                    </a>
                                </li>

                                <!-- Instagram (Instagram doesn’t have native sharing for URLs, so we can link to profile or skip) -->
                                <li class="social__shear--list">
                                    <a class="social__shear--list__icon" target="_blank"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16.497" height="16.492"
                                            ...
                                            <path data-name="Icon awesome-instagram"
                                                ...
                                                transform="translate(0.004 -1.492)" fill="#000" />
                                        </svg>
