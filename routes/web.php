...
Route::group(['prefix' => '/home', 'middleware' => ['auth', 'verified', 'adminAuth']], function () {
	...
	Route::group(['prefix' => 'setting', 'as' => 'setting.'], function () {
		...
		Route::get('/feature-video', [App\Http\Controllers\SettingController::class, 'featureVideo'])->name('feature.video');
		Route::post('/feature-video', [App\Http\Controllers\SettingController::class, 'storeFeatureVideo'])->name('store.feature.video');
		Route::delete('/feature-video/{id}', [App\Http\Controllers\SettingController::class, 'destroyFeatureVideo'])->name('delete.feature.video');
